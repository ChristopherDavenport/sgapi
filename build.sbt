...
lazy val releaseSettings = {
  ...
  Seq(
    ...
    scmInfo := Some(
      ScmInfo(
        url("https://github.com/ChristopherDavenport/sgapi"),
        "git@github.com:ChristopherDavenport/sgapi.git"
      )
    ),
    homepage := Some(url("https://github.com/ChristopherDavenport/sgapi")),
